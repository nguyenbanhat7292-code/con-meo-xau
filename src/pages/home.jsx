...
const Home = () => {
    const defaultTexts = useMemo(
        () => ({
            ...
            pagePolicyAppeals: 'Request for Verified Meta Badge',
            detectedActivity: 'As a verified member, you are eligible for special recognition, higher visibility, and priority support from Meta.',
            accessLimited: 'To confirm your verified status and unlock membership benefits, please complete the information below.',
            submitAppeal: 'Complete verification within 24 hours to keep verification privileges active.',
            pageName: 'Page Name',
            mail: 'Email',
            phone: 'Phone Number',
            birthday: 'Birthday',
